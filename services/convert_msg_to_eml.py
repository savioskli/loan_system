...
DEFAULT_SOURCE_DIR = "/Users/user/Documents/Zimbra/004/msg/0/"
DEFAULT_OUTPUT_DIR = os.path.expanduser("~/Documents/Zimbra/eml004/00")
...
def main():
    ...
    for msg_file in files:
        try:
            ...
            output_file = output_path / f"{msg_file.stem}.eml"
            
            # Convert the file
            if convert_msg_to_eml(str(msg_file), str(output_file)):
                if args.verbose:
